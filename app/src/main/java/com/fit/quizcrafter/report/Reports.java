...
public class Reports extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapterStart = ArrayAdapter.createFromResource(getContext(), R.array.start_date_array, android.R.layout.simple_spinner_item);
        adapterStart.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        binding.startSpinner.setAdapter(adapterStart);

        ArrayAdapter<CharSequence> adapterEnd = ArrayAdapter.createFromResource(getContext(), R.array.end_date_array, android.R.layout.simple_spinner_item);
        adapterEnd.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        binding.endSpinner.setAdapter(adapterEnd);
